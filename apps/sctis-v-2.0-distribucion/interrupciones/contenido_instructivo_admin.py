"""Contenido del INSTRUCTIVO ISO SCTIS — Procedimiento de administración y supervisión.

Dirigido a administradores y supervisores del sistema. Por ahora, el perfil
Supervisor comparte las funciones del Administrador; cuando se diferencie,
este instructivo deberá actualizarse.
"""

TITULO = "INSTRUCTIVO ISO PARA ADMINISTRADORES\nY SUPERVISORES DEL SISTEMA"
SUBTITULO = "Sistema de Gestión de Tiras de Interrupción Eléctrica — Guía de administración y supervisión"
SISTEMA = "SCTIS v1.0"
DOC_CODIGO = "SCTIS-INSTR-ADM-001"
FECHA = "Agosto 2026"

BLOCKS = [
    ("h1", "1. Propósito y Alcance"),
    ("p", "Este instructivo describe los procedimientos de administración y supervisión del Sistema de Gestión de Tiras de Interrupción Eléctrica (SCTIS): gestión de usuarios, revisión de auditoría de cargas, gestión de tareas pendientes y, de forma destacada, la supervisión de subestaciones (SE) y circuitos (CT) reportados fuera del catálogo oficial.\n\nVa dirigido a los administradores y supervisores del sistema. Por ahora el perfil Supervisor comparte las mismas funciones del Administrador; cuando los roles se diferencien, este documento deberá actualizarse para reflejar los alcances de cada perfil."),

    ("info", "Mientras no se indique lo contrario, en este documento 'administrador' y 'supervisor' son intercambiables: ambos acceden a los mismos módulos de gestión y supervisión.", "NOTA DE ROLES"),
    ...
    ("h1", "3. Responsabilidades del administrador/supervisor"),
    ("bullets", [
    ...
    ("h1", "4. Gestión de usuarios"),
    ("p", "El módulo 'Admin → Usuarios' permite administrar las cuentas de los estados operadores."),
    ("h2", "4.1. Crear un usuario"),
    ("bullets", [
    ...
    ("h2", "4.2. Editar, restablecer contraseña y desactivar"),
    ("bullets", [
    ...
    ("info", "La cuenta se bloquea automáticamente tras 5 intentos fallidos durante 30 minutos. Solo el administrador puede restablecerla antes.", "SEGURIDAD"),

    ("h1", "5. Auditoría de cargas"),
    ("p", "El módulo 'Admin → Auditoría' muestra el registro de todas las importaciones: usuario, estado, archivo, hoja, cantidad de registros intentados, aceptados y rechazados, formato detectado y estado de validación."),
    ("bullets", [
    ...
    ("h1", "6. Monitoreo de cargas y matriz de cumplimiento por estado"),
    ("p", "El módulo 'Admin → Monitoreo' permite evaluar en tiempo real la disciplina de entrega de los 24 estados de Venezuela, clasificando de forma transparente quiénes han cumplido y quiénes están en mora tanto en la frecuencia semanal como en el consolidado mensual."),
    ("h2", "6.1. Criterios de evaluación de cumplimiento"),
    ("table",
    ...
    ("h2", "6.2. Paneles de alerta y acción directa"),
    ("bullets", [
    ...
    ("h1", "7. Gestión de tareas pendientes"),
    ("p", "El módulo 'Admin → Tareas' centraliza las tareas que requieren acción. Tipos de tareas:"),
    ("table",
    ...
    ("h2", "8.2. Aprobar (crear el activo en el catálogo)"),
    ("bullets", [
    ...
    ("h2", "8.3. Asignar como alias (existe con otro nombre)"),
    ("bullets", [
    ...
    ("h2", "8.4. Corregir el nombre sugerido"),
    ("bullets", [
    ...
    ("tech", "Cada decisión queda auditada: quién decidió, cuándo y con qué comentario (trazabilidad ISO 27001). La creación del activo usa source_process = 'sctis_import' y created_by del administrador.", "NOTA TÉCNICA"),

    ("h1", "9. Decisiones de la bandeja (resumen)"),
    ("table",
    ...
    ("h1", "10. Buenas prácticas de supervisión"),
    ("bullets", [
    ...
    ("h1", "11. Errores frecuentes de supervisión"),
    ("table",
    ...
    ("h1", "Anexo B — Referencias al modelo de datos"),
    ("table",
