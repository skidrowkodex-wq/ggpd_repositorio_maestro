...
export const HeaderInstitutional: React.FC = () => {
  return (
    <div className="w-full bg-slate-100/90 dark:bg-[#040914] text-slate-800 dark:text-slate-200 border-b border-slate-200/90 dark:border-slate-800/80 transition-colors">
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-6 py-2 sm:py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs">
        
        {/* Left: Official MPPEE Identity */}
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className="h-7 sm:h-9 flex items-center">
            <MppeeLogo className="h-7 sm:h-8.5 w-auto max-w-[240px] sm:max-w-[320px]" />
          </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="flex items-center space-x-1.5 px-2 py-0.5 rounded-md bg-emerald-50 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 border border-emerald-200/80 dark:border-emerald-500/30 text-[10px] font-mono font-bold">
          ...
          <div className="flex items-center space-x-1 px-2 py-0.5 rounded-full bg-purple-50 dark:bg-purple-950/50 text-purple-800 dark:text-purple-300 border border-purple-200/70 dark:border-purple-500/30 text-[10px] font-bold shadow-2xs">
