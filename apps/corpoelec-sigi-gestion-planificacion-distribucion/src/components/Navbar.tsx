    ...
    <>
      <header className="sticky top-0 z-30 w-full border-b border-slate-200/90 dark:border-slate-800 bg-white/95 dark:bg-[#070f1e]/95 backdrop-blur-xl transition-colors shadow-2xs">
        <div className="mx-auto max-w-7xl px-2.5 sm:px-6">
          <div className="flex h-12 sm:h-16 items-center justify-between gap-2 sm:gap-3">
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-3">
              ...
              <div 
                className="flex items-center space-x-1.5 sm:space-x-3 cursor-pointer select-none group" 
              ...
              >
                ...
                <div className="flex lg:hidden h-6.5 sm:h-8 px-1 sm:px-2 py-0.5 rounded-md bg-white border border-slate-200 dark:border-slate-700/80 shadow-2xs items-center justify-center shrink-0">
                  <CorpoelecLogo className="h-3.5 sm:h-5 w-auto max-w-[50px] sm:max-w-[80px]" />
                </div>
                ...
                {/* Vertical Separator */}
                <div className="hidden sm:block h-5 w-px bg-slate-200 dark:bg-slate-700/80" />
                ...
                <div className="flex items-center space-x-1 sm:space-x-2">
                  ...
                  <div>
                    <div className="flex items-center space-x-1 sm:space-x-1.5 leading-none">
                      <span className="text-[11px] sm:text-sm font-extrabold tracking-tight text-slate-900 dark:text-white truncate max-w-[130px] xs:max-w-[190px] sm:max-w-none">
                        Planificación Distribución
                      </span>
                      <span className="rounded bg-blue-50 text-blue-700 dark:bg-cyan-950/60 dark:text-cyan-300 border border-blue-200 dark:border-cyan-500/30 px-1 py-0.2 text-[7.5px] sm:text-[9px] font-mono font-bold">
                        GGPD
                      </span>
                    </div>
                    <button 
                      ...
                      className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400 hover:text-[#002b49] dark:hover:text-[#00f2fe] font-medium mt-0.5 hidden xs:flex items-center space-x-1 transition-colors text-left"
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-3">
            ...
            <button
              ...
              className="flex items-center justify-center h-7.5 w-7.5 sm:h-auto sm:w-auto sm:px-3 sm:py-1.5 rounded-lg sm:rounded-xl border border-slate-200 dark:border-slate-700/80 bg-slate-50 dark:bg-slate-800/80 text-slate-700 dark:text-slate-200 text-xs font-bold hover:bg-slate-100 dark:hover:bg-slate-700 transition-all shadow-2xs"
            >
              {theme === 'light' ? (
                <>
            ...
            {session.authenticated ? (
              <div className="flex items-center space-x-1 sm:space-x-2">
                ...
                <button
                  onClick={logout}
                  className="flex items-center space-x-1 rounded-lg sm:rounded-xl bg-red-50 dark:bg-red-950/40 px-2 sm:px-3 py-1.5 text-xs font-bold text-red-600 dark:text-red-300 border border-red-200 dark:border-red-500/40 hover:bg-red-100 dark:hover:bg-red-900/60 transition-colors shadow-2xs h-7.5 sm:h-auto"
                >
              ...
              <button
                ...
                className="flex items-center space-x-1 sm:space-x-1.5 rounded-lg sm:rounded-xl bg-[#002b49] hover:bg-[#003961] text-white dark:bg-gradient-to-r dark:from-[#00f2fe] dark:to-[#38bdf8] dark:text-[#060d1a] px-2.5 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-xs font-black uppercase shadow-xs hover:shadow-sm active:scale-95 transition-all h-7.5 sm:h-auto"
              >
