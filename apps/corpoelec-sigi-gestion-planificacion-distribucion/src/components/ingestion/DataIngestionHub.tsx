...
export const DataIngestionHub: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-slate-300 font-medium">Validación ISO 8000-110 en Caliente</span>
            </div>
            ...
            <p className="text-xs sm:text-sm text-slate-300 max-w-3xl mt-1">
              Directiva Zero-WhatsApp / Zero-Email. Valide la estructura de sus archivos operativos, segregue registros conformes y genere planillas de remediación con trazabilidad auditada.
            </p>
          </div>
      ...
      {/* Selector de Pestañas: Cargar vs Historial */}
      <div className="flex items-center space-x-2 border-b border-slate-200 dark:border-slate-800 pb-2">
        ...
        >
          ...
          <span>Ingesta y Validación de Archivo</span>
        </button>
        ...
        >
          ...
          <span>Historial de Cargas Estadal ({submissions.length})</span>
        </button>
      </div>
      ...
      {activeTab === 'upload' && (
        <div className="space-y-6">
          ...
          {/* 1. SELECCIÓN DE PROCESO (TARJETAS INTELIGENTES) */}
          <div>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-xs font-black uppercase tracking-wider text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                <Layers className="h-4 w-4 text-[#002b49] dark:text-[#00f2fe]" />
                1. Seleccione el Proceso a Cargar ({processes.length} Procesos Estandarizados)
              </h3>
            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                <h3 className="text-xs font-black uppercase tracking-wider text-slate-700 dark:text-slate-300">
                  2. Carga del Archivo Operativo ({currentProcess.name})
                </h3>
              ...
              <div className="flex items-center space-x-2 text-xs font-mono text-slate-500">
                ...
                <span>Corte: Jueves 12:00 PM</span>
              </div>
            </div>
          ...
          {/* 3. REPORTE DE RESULTADOS DE VALIDACIÓN (ISO 8000) */}
          {validationReport && (
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xs space-y-6 animate-fadeIn">
              ...
              {/* 3.1 Verificación de Nomenclatura */}
              ...
              {/* 3.2 Métricas de Segregación (Conformes vs No Conformes) */}
              ...
              {/* 3.3 Tabla de Errores Detectados (Si existen) */}
              ...
              {/* 3.4 Acciones Finales de Confirmación */}
              {!submissionSuccess ? (
                <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
                  <p className="text-xs text-slate-500">
                    Al confirmar, los <strong className="text-emerald-600">{validationReport.validRowsCount} registros conformes</strong> se subirán automáticamente al Data Lake en Google Drive y a la base de datos de {currentProcess.targetApp}.
                  </p>
                ...
                /* Mensaje de Éxito y Carpeta de Destino */
                <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-800 dark:text-emerald-200 text-xs space-y-2 animate-fadeIn">
                  <div className="flex items-center space-x-2 font-bold text-sm">
                    ...
                    <span>¡Carga Procesada Exitosamente en el Data Lake SEN!</span>
                  </div>
                  <p>
      ...
      {/* VISTA 2: HISTORIAL DE CARGAS ESTADAL */}
      {activeTab === 'history' && (
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xs space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Registro de archivos normalizados, cantidad de registros procesados y tareas de remediación asociadas.
              </p>
            </div>
          </div>
          ...
          {submissions.length === 0 ? (
            <div className="text-center py-8 text-slate-400 text-xs">
              No hay envíos registrados todavía. Realice una carga en la pestaña 'Ingesta y Validación de Archivo'.
            </div>
          ) : (
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-50 dark:bg-slate-800/80 text-slate-600 dark:text-slate-300 font-bold">
                  <tr>
                    ...
                    <th className="py-2.5 px-3">Archivo Normalizado</th>
