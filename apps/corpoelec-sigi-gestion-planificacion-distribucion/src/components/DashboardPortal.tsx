    ...
    <div className="space-y-8 py-6">
      ...
      <div className="rounded-3xl bg-white dark:bg-gradient-to-r dark:from-[#112240] dark:via-[#0a192f] dark:to-[#112240] p-6 border border-slate-200 dark:border-[#00f2fe]/30 shadow-md">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="space-y-1">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="rounded-full bg-emerald-100 text-emerald-900 border border-emerald-300 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/30 px-2.5 py-0.5 text-[10px] font-extrabold">
                Rol: {session.role}
              </span>
            </div>

            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white">
              Sistema Integrado de Información — <span className="text-gradient">{currentStateObj.name}</span>
            </h1>
          </div>
          ...
          <div className="flex items-center space-x-3 rounded-2xl bg-slate-50 dark:bg-[#0a192f] p-3 border border-slate-300 dark:border-[#00f2fe]/40 shadow-sm">
            ...
            <div>
              <div className="text-[10px] font-extrabold text-slate-600 dark:text-slate-300 uppercase tracking-wider">Estado Geográfico Asignado</div>
              <select
        ...
        <div className="mt-6 flex flex-wrap items-center gap-2 border-t border-slate-200 dark:border-slate-800 pt-4">
          ...
          {/* Module 5: User Management (Admin / Gerencia) */}
          <button
