...
export const FloatingSecurityWidget: React.FC = () => {
  ...
  return (
    <>
      {/* FLOATING TRIGGER BUTTON (Elevated above VibeHost badge) */}
      <button
        onClick={() => setIsOpen(true)}
        className="fixed bottom-16 sm:bottom-20 right-4 sm:right-6 z-40 flex items-center space-x-2.5 rounded-full bg-slate-900/95 text-white dark:bg-[#091830]/95 dark:text-[#00f2fe] p-2.5 pr-4 border border-emerald-500/40 dark:border-[#00f2fe]/40 shadow-2xl backdrop-blur-md hover:scale-105 transition-all group ring-4 ring-emerald-500/10 dark:ring-[#00f2fe]/10"
