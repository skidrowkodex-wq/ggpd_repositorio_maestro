  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-[#041426] flex flex-col justify-center py-10 sm:px-6 lg:px-8 transition-colors duration-200 relative">
      ...
      <div className="absolute top-4 right-4 z-50">
        <button
          onClick={toggleTheme}
          className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white dark:bg-[#072146] text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-purple-900/60 shadow-sm text-xs font-semibold hover:border-purple-500 transition-colors"
        >
          {theme === 'dark' ? (
            <>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <div className="flex justify-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 via-indigo-600 to-purple-800 flex items-center justify-center text-white shadow-xl shadow-purple-600/30 ring-4 ring-purple-500/20">
        ...
        <p className="mt-1 text-center text-xs font-bold uppercase tracking-wider text-purple-700 dark:text-purple-300 font-mono">
          PROCESO GGPD-SEC-01 • GESTIÓN DE CORRESPONDENCIA CORPORATIVA
        </p>
        ...
        <div className="mt-2 inline-flex items-center gap-1 text-[10px] font-mono font-bold text-slate-500 dark:text-slate-400 bg-slate-200/60 dark:bg-[#072146] px-2.5 py-0.5 rounded-md border border-slate-300 dark:border-purple-900/60">
      ...
      <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
        <div className="bg-white dark:bg-[#072146] py-8 px-6 sm:px-9 shadow-2xl rounded-2xl border border-slate-200 dark:border-purple-900/40 relative overflow-hidden">
          
          {/* Top Security Line Indicator */}
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-emerald-500 via-purple-500 to-indigo-500"></div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="text"
                placeholder="ej: b_gonzalez o b.gonzalez@corpoelec.gob.ve"
                value={username}
                onChange={(e) => setUsername(e.target.value)}
                className="w-full rounded-xl bg-slate-50 dark:bg-[#041426] border border-slate-300 dark:border-slate-700 px-3.5 py-2.5 text-xs text-slate-900 dark:text-white placeholder-slate-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20 font-mono font-medium transition-all"
                required
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl bg-slate-50 dark:bg-[#041426] border border-slate-300 dark:border-slate-700 px-3.5 py-2.5 text-xs text-slate-900 dark:text-white placeholder-slate-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20 font-mono transition-all pr-10"
                  required
            ...
            <div className="rounded-xl bg-slate-50 dark:bg-[#061224] p-3 border border-slate-200 dark:border-slate-800 text-[11px] text-slate-600 dark:text-slate-400 flex items-start gap-2.5">
              ...
              <p className="leading-snug">
                El nivel de acceso y permisos se configuran automáticamente según el rol del usuario autenticado. Sesión auditada bajo norma <strong>ISO/IEC 27001</strong>.
              </p>
            </div>
          ...
          {/* Footer Multi-Normative Security Badges */}
          <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-800 space-y-2">
            ...
            <div className="text-[10px] text-center text-slate-400 dark:text-slate-500 pt-1">
              Plataforma protegida con cifrado TLS 1.3 • Hash SHA-256 inmutable por expediente.
            </div>
          </div>
