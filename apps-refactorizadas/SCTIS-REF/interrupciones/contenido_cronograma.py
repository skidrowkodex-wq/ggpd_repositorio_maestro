"""Contenido del CRONOGRAMA DE IMPLEMENTACIÓN SCTIS — Planificación del piloto.

Planificación secuencial (sin paralelismo): un único programador atiende el
piloto SCTIS; los dos desarrollos adicionales se inician al cierre de este.
"""

TITULO = "CRONOGRAMA DE IMPLEMENTACIÓN\nDEL PILOTO SCTIS"
SUBTITULO = "Actividades, entregables y fechas probables de entrega del piloto"
SISTEMA = "SCTIS v1.0"
DOC_CODIGO = "SCTIS-CRONO-001"
FECHA = "Agosto 2026"

BLOCKS = [
    ("h1", "1. Propósito y Alcance"),
    ("p", "Este cronograma define la planificación de la implementación del piloto del Sistema de Gestión de Tiras de Interrupción Eléctrica (SCTIS): las actividades, su duración estimada, los entregables, las fechas probables de inicio y fin, y los hitos de control.\n\nEl proyecto es atendido por un único programador, por lo que las actividades se ejecutan en forma SECUENCIAL, sin paralelismo. Al finalizar este piloto se iniciarán los otros dos desarrollos pendientes, que dependen de él."),

    ("h1", "2. Contexto y Supuestos"),
    ("h2", "2.1. Estado actual"),
    ("bullets", [
    ...
    ("h2", "2.2. Supuestos de planificación"),
    ("bullets", [
    ...
    ("h1", "3. Metodología de Estimación"),
    ("p", "Las duraciones se estimaron a partir del avance real del proyecto, de las actividades pendientes registradas en la planificación y de la experiencia del responsable. Cada fase define su entregable y su hito de control."),
    ("info", "Las fechas son PROBABLES, no contractuales. El hito de aprobación lo fijan los ingenieros; a partir de él las fechas se recalculan con la regla indicada en la sección 7.", "NOTA"),
    ("flow", [
    ...
    ("h1", "4. Fases del Cronograma"),
    ("p", "Las fases se ejecutan en forma estrictamente secuencial. La duración de cada fase se expresa en días hábiles."),
    ("table",
    ...
    ("tech", "Duración total estimada: 13 días hábiles desde el inicio de la fase F1. La fase F1 comienza el día hábil siguiente a la entrega del cronograma.", "TOTAL"),

    ("h1", "5. Cronograma con Fechas Probables"),
    ("p", "Suponiendo el inicio de la fase F1 el martes 04 de agosto de 2026 (primer día hábil tras el lunes no laborable), las fechas son:"),
    ("table",
    ...
    ("info", "GO-LIVE del piloto (fecha probable): JUEVES 20 DE AGOSTO DE 2026.", "HITO PRINCIPAL"),

    ("h1", "6. Hitos de Control"),
    ("table",
    ...
    ("h1", "7. Regla de Recálculo tras la Aprobación"),
    ("p", "La fecha de GO-LIVE depende de la fecha real de aprobación. Desde la aprobación restan 10 días hábiles de trabajo (fases F2 a F7):"),
    ("flow", [
    ...
    ("tech", "Si la aprobación ocurre en una fecha distinta, aplique la regla: GO-LIVE = fecha de aprobación + 10 días hábiles.", "RECÁLCULO"),

    ("h1", "8. Entregables por Fase"),
    ("table",
    ...
    ("h1", "9. Riesgos y Supuestos de Fechas"),
    ("table",
    ...
    ("h1", "10. Nota sobre los Desarrollos Adicionales"),
    ("p", "Existen dos desarrollos adicionales planificados que dependen de este proyecto. Por política de gestión y por contar con un único programador, no es recomendable atender varios proyectos en paralelo, especialmente cuando están enlazados entre sí. Ambos desarrollos se iniciarán al cierre del piloto SCTIS, siguiendo la misma metodología de planificación y control aquí descrita."),

    ("pagebreak",),

    ("h1", "Anexo A — Vista Resumida del Cronograma"),
    ("p", "Representación visual simplificada de la secuencia de fases sobre los 13 días hábiles del calendario (▓▓ = día de actividad, · = día sin actividad):"),
    ("code",
